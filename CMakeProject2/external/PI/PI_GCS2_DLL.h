...
extern "C" {
    ...
    // Define the necessary types if not already defined
#ifndef BOOL
    typedef int BOOL;
#endif
#ifndef WIN32
...
int PI_FUNC_DECL PI_StartDaisyChainScanRS232ByDevName (
    const char* szDevName,
    int iBaudRate);
#endif
...
int PI_FUNC_DECL PI_StartDaisyChainScanTCPIP (
    const char* szHostname,
    int port);
int PI_FUNC_DECL PI_StartDaisyChainScanRS232 (int iPortNumber, int iBaudRate);
int PI_FUNC_DECL PI_StartDaisyChainScanUSB (
    const char* szDescription);
int PI_FUNC_DECL PI_DaisyChainScanning (int threadId, BOOL* scanning, double* progressPercentage);

int PI_FUNC_DECL PI_GetDaisyChainID (int threadId);
int PI_FUNC_DECL PI_GetDevicesInDaisyChain (int portId, int* numberOfDevices, char* buffer, int bufferSize);
int PI_FUNC_DECL PI_StopDaisyChainScan (int threadId);

int PI_FUNC_DECL PI_GetConnectedDaisyChains(int* daisyChainIds, int nrDaisyChainsIds);
int PI_FUNC_DECL PI_GetNrConnectedDaisyChains();
void PI_FUNC_DECL PI_CloseAllDaisyChains();
...
int PI_FUNC_DECL PI_GetError(
    int ID);
int PI_FUNC_DECL PI_GetInitError();
...
BOOL PI_FUNC_DECL PI_qUSG_HW(
    ...
    char* usg,
    int bufSize);
BOOL PI_FUNC_DECL PI_qUSG_PROP(
    int ID,
    const char* chapter,
    char* usg,
    int bufSize);
...
BOOL PI_FUNC_DECL PI_SAM(
    ...
    unsigned int axisOperationMode);
BOOL PI_FUNC_DECL PI_qSAM(
    int ID,
    const char* axisContainerUnit,
    unsigned int* axesOperationModesArray);
BOOL PI_FUNC_DECL PI_RES (
    int ID,
    const char* axisContainerUnit);
BOOL PI_FUNC_DECL PI_SMV (
    int ID,
    const char* axisContainerUnitsArray,
    const double* numberOfStepsArray);
BOOL PI_FUNC_DECL PI_qSMV (
    int ID,
    const char* axisContainerUnit,
    double* commandedSteps);
BOOL PI_FUNC_DECL PI_qSMR (
    int ID,
    const char* axisContainerUnit,
    double* remainingSteps);
BOOL PI_FUNC_DECL PI_OCV (
    int ID,
    const char* axisContainerUnitsArray,
    const double* controlValueArray);
BOOL PI_FUNC_DECL PI_qOCV (
    int ID,
    const char* axisContainerUnit,
    double* controlValueArray);
