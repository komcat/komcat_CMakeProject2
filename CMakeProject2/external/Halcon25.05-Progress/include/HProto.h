...
LIntExport Herror T_apply_deep_matching_3d(const Hobject Images, const Htuple Deep3DMatchingModel, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DeepMatchingResults);
...
LIntExport Herror T_connect_image_source(const Htuple ImageSourceHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_control_image_source(const Htuple ImageSourceHandle, const Htuple Action, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Result);
LIntExport Herror T_create_deep_matching_3d(const Htuple ObjectModel3D, const Htuple Symmetry, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Deep3DMatchingModel);
LIntExport Herror T_create_dl_layer_affine_grid(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Width, const Htuple Height, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerAffineGrid);
LIntExport Herror T_create_dl_layer_anchors(const Htuple DLLayerInput, const Htuple DLLayerInputImage, const Htuple LayerName, const Htuple AspectRatios, const Htuple NumSubscales, const Htuple Angles, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerAnchors);
LIntExport Herror T_create_dl_layer_box_proposals(const Htuple DLLayerClassScore, const Htuple DLLayerBoxDelta, const Htuple DLLayerBox, const Htuple DLLayerInputImage, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerBoxProposals);
LIntExport Herror T_create_dl_layer_box_targets(const Htuple DLLayerBoxProposal, const Htuple DLLayerGTBox, const Htuple DLLayerGTMask, const Htuple LayerNames, const Htuple InputMode, const Htuple OutputModes, const Htuple NumClasses, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerBoxTargetsClsTarget, Htuple *DLLayerBoxTargetsClsWeight, Htuple *DLLayerBoxTargetsBoxTarget, Htuple *DLLayerBoxTargetsBoxWeight, Htuple *DLLayerBoxTargetsNumFgInstances, Htuple *DLLayerBoxTargetsAssignedIdxs, Htuple *DLLayerBoxTargetsMaskWeight);
LIntExport Herror T_create_dl_layer_grid_sample(const Htuple DLLayerInput, const Htuple DLLayerGrid, const Htuple LayerName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerGridSample);
LIntExport Herror T_create_dl_layer_roi_pooling(const Htuple DLLayerInputImage, const Htuple DLLayerRoI, const Htuple DLLayerFeature, const Htuple DLLayerInstanceIndex, const Htuple LayerName, const Htuple Type, const Htuple GridSize, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerRoIPooling);
LIntExport Herror T_create_dl_layer_slice(const Htuple DLLayerInput, const Htuple LayerName, const Htuple Axes, const Htuple StartIndices, const Htuple EndIndices, const Htuple Steps, const Htuple GenParamName, const Htuple GenParamValue, Htuple *DLLayerSlice);
LIntExport Herror T_create_image_source(const Htuple PluginName, const Htuple DeviceID, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ImageSourceHandle);
LIntExport Herror T_disconnect_image_source(const Htuple ImageSourceHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_fetch_from_image_source(Hobject *Images, const Htuple ImageSourceHandle, Htuple *Data);
LIntExport Herror T_gen_image_warp_map(Hobject *Map, const Htuple Row1, const Htuple Column1, const Htuple Row2, const Htuple Column2, const Htuple ImageWidth, const Htuple ImageHeight, const Htuple MapWidth, const Htuple MapHeight, const Htuple Method, const Htuple MapType, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_get_image_source_param(const Htuple ImageSourceHandle, const Htuple Param, const Htuple GenParamName, const Htuple GenParamValue, Htuple *Value);
LIntExport Herror T_get_scene_engine_param(const Htuple SceneEngine, const Htuple GenParamName, Htuple *GenParamValue);
LIntExport Herror T_open_scene_engine(const Htuple GenParamName, const Htuple GenParamValue, Htuple *SceneEngine);
LIntExport Herror T_query_image_sources(const Htuple PluginName, const Htuple GenParamName, const Htuple GenParamValue, Htuple *ImageSourceHandles);
LIntExport Herror T_run_scene_engine(const Htuple SceneEngine, const Htuple GenerationParams, Htuple *GeneratedData);
LIntExport Herror T_set_image_source_param(const Htuple ImageSourceHandle, const Htuple Param, const Htuple GenParamName, const Htuple GenParamValue, const Htuple Value);
LIntExport Herror T_set_scene_engine_param(const Htuple SceneEngine, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_snap_from_image_source(Hobject *Images, const Htuple ImageSourceHandle, Htuple *Data);
LIntExport Herror T_start_image_source(const Htuple ImageSourceHandle, const Htuple GenParamName, const Htuple GenParamValue);
LIntExport Herror T_stop_image_source(const Htuple ImageSourceHandle, const Htuple GenParamName, const Htuple GenParamValue);
