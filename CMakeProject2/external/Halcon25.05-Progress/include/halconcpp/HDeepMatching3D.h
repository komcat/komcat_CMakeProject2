 ...
 *****************************************************************************/
  ...
  explicit HDeepMatching3D(const HObjectModel3D& ObjectModel3D, const HTuple& Symmetry, const HTuple& GenParamName, const HTuple& GenParamValue);

  // create_deep_matching_3d: Create a Deep 3D Matching model.
  explicit HDeepMatching3D(const HObjectModel3D& ObjectModel3D, const HString& Symmetry, const HString& GenParamName, const HString& GenParamValue);

  // create_deep_matching_3d: Create a Deep 3D Matching model.
  explicit HDeepMatching3D(const HObjectModel3D& ObjectModel3D, const char* Symmetry, const char* GenParamName, const char* GenParamValue);

#ifdef _WIN32
  // create_deep_matching_3d: Create a Deep 3D Matching model.
  explicit HDeepMatching3D(const HObjectModel3D& ObjectModel3D, const wchar_t* Symmetry, const wchar_t* GenParamName, const wchar_t* GenParamValue);
#endif
  ...
  HDict ApplyDeepMatching3d(const HImage& Images, const HTuple& GenParamName, const HTuple& GenParamValue) const;
  ...
  void CreateDeepMatching3d(const HObjectModel3D& ObjectModel3D, const HTuple& Symmetry, const HTuple& GenParamName, const HTuple& GenParamValue);

  // Create a Deep 3D Matching model.
  void CreateDeepMatching3d(const HObjectModel3D& ObjectModel3D, const HString& Symmetry, const HString& GenParamName, const HString& GenParamValue);

  // Create a Deep 3D Matching model.
  void CreateDeepMatching3d(const HObjectModel3D& ObjectModel3D, const char* Symmetry, const char* GenParamName, const char* GenParamValue);

#ifdef _WIN32
  // Create a Deep 3D Matching model.
  void CreateDeepMatching3d(const HObjectModel3D& ObjectModel3D, const wchar_t* Symmetry, const wchar_t* GenParamName, const wchar_t* GenParamValue);
#endif

  // Read a parameter from a running Scene Engine instance.
  static HTuple GetSceneEngineParam(const HSceneEngine& SceneEngine, const HTuple& GenParamName);

  // Read a parameter from a running Scene Engine instance.
  static HTuple GetSceneEngineParam(const HSceneEngine& SceneEngine, const HString& GenParamName);

  // Read a parameter from a running Scene Engine instance.
  static HTuple GetSceneEngineParam(const HSceneEngine& SceneEngine, const char* GenParamName);

#ifdef _WIN32
  // Read a parameter from a running Scene Engine instance.
  static HTuple GetSceneEngineParam(const HSceneEngine& SceneEngine, const wchar_t* GenParamName);
#endif

  // Start and connect to the scene engine synthetic data generator.
  static HSceneEngine OpenSceneEngine(const HTuple& GenParamName, const HTuple& GenParamValue);

  // Start and connect to the scene engine synthetic data generator.
  static HSceneEngine OpenSceneEngine(const HString& GenParamName, const HString& GenParamValue);

  // Start and connect to the scene engine synthetic data generator.
  static HSceneEngine OpenSceneEngine(const char* GenParamName, const char* GenParamValue);

#ifdef _WIN32
  // Start and connect to the scene engine synthetic data generator.
  static HSceneEngine OpenSceneEngine(const wchar_t* GenParamName, const wchar_t* GenParamValue);
#endif

  // Generate synthetic data using a running Scene Engine instance.
  static HDict RunSceneEngine(const HSceneEngine& SceneEngine, const HDict& GenerationParams);

  // Sets a parameter of a running Scene Engine instance.
  static void SetSceneEngineParam(const HSceneEngine& SceneEngine, const HString& GenParamName, const HTuple& GenParamValue);

  // Sets a parameter of a running Scene Engine instance.
  static void SetSceneEngineParam(const HSceneEngine& SceneEngine, const HString& GenParamName, const HString& GenParamValue);

  // Sets a parameter of a running Scene Engine instance.
  static void SetSceneEngineParam(const HSceneEngine& SceneEngine, const char* GenParamName, const char* GenParamValue);

#ifdef _WIN32
  // Sets a parameter of a running Scene Engine instance.
  static void SetSceneEngineParam(const HSceneEngine& SceneEngine, const wchar_t* GenParamName, const wchar_t* GenParamValue);
#endif
