...
LIntExport Herror apply_deep_matching_3d(const HObject& Images, const HTuple& Deep3DMatchingModel, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DeepMatchingResults);
...
LIntExport Herror connect_image_source(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror control_image_source(const HTuple& ImageSourceHandle, const HTuple& Action, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Result);

LIntExport Herror create_deep_matching_3d(const HTuple& ObjectModel3D, const HTuple& Symmetry, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Deep3DMatchingModel);

LIntExport Herror create_dl_layer_affine_grid(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerAffineGrid);

LIntExport Herror create_dl_layer_anchors(const HTuple& DLLayerInput, const HTuple& DLLayerInputImage, const HTuple& LayerName, const HTuple& AspectRatios, const HTuple& NumSubscales, const HTuple& Angles, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerAnchors);

LIntExport Herror create_dl_layer_box_proposals(const HTuple& DLLayerClassScore, const HTuple& DLLayerBoxDelta, const HTuple& DLLayerBox, const HTuple& DLLayerInputImage, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBoxProposals);

LIntExport Herror create_dl_layer_box_targets(const HTuple& DLLayerBoxProposal, const HTuple& DLLayerGTBox, const HTuple& DLLayerGTMask, const HTuple& LayerNames, const HTuple& InputMode, const HTuple& OutputModes, const HTuple& NumClasses, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBoxTargetsClsTarget, HTuple* DLLayerBoxTargetsClsWeight, HTuple* DLLayerBoxTargetsBoxTarget, HTuple* DLLayerBoxTargetsBoxWeight, HTuple* DLLayerBoxTargetsNumFgInstances, HTuple* DLLayerBoxTargetsAssignedIdxs, HTuple* DLLayerBoxTargetsMaskWeight);

LIntExport Herror create_dl_layer_grid_sample(const HTuple& DLLayerInput, const HTuple& DLLayerGrid, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerGridSample);

LIntExport Herror create_dl_layer_roi_pooling(const HTuple& DLLayerInputImage, const HTuple& DLLayerRoI, const HTuple& DLLayerFeature, const HTuple& DLLayerInstanceIndex, const HTuple& LayerName, const HTuple& Type, const HTuple& GridSize, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerRoIPooling);

LIntExport Herror create_dl_layer_slice(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Axes, const HTuple& StartIndices, const HTuple& EndIndices, const HTuple& Steps, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerSlice);

LIntExport Herror create_image_source(const HTuple& PluginName, const HTuple& DeviceID, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ImageSourceHandle);

LIntExport Herror disconnect_image_source(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror fetch_from_image_source(HObject* Images, const HTuple& ImageSourceHandle, HTuple* Data);

LIntExport Herror gen_image_warp_map(HObject* Map, const HTuple& Row1, const HTuple& Column1, const HTuple& Row2, const HTuple& Column2, const HTuple& ImageWidth, const HTuple& ImageHeight, const HTuple& MapWidth, const HTuple& MapHeight, const HTuple& Method, const HTuple& MapType, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror get_image_source_param(const HTuple& ImageSourceHandle, const HTuple& Param, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Value);

LIntExport Herror get_scene_engine_param(const HTuple& SceneEngine, const HTuple& GenParamName, HTuple* GenParamValue);

LIntExport Herror open_scene_engine(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SceneEngine);

LIntExport Herror query_image_sources(const HTuple& PluginName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ImageSourceHandles);

LIntExport Herror run_scene_engine(const HTuple& SceneEngine, const HTuple& GenerationParams, HTuple* GeneratedData);

LIntExport Herror set_image_source_param(const HTuple& ImageSourceHandle, const HTuple& Param, const HTuple& GenParamName, const HTuple& GenParamValue, const HTuple& Value);

LIntExport Herror set_scene_engine_param(const HTuple& SceneEngine, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror snap_from_image_source(HObject* Images, const HTuple& ImageSourceHandle, HTuple* Data);

LIntExport Herror start_image_source(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

LIntExport Herror stop_image_source(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
