 ...
 *****************************************************************************/
  ...
  // Create an affine grid layer.
  HDlLayer CreateDlLayerAffineGrid(const HString& LayerName, Hlong Width, Hlong Height, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Create an affine grid layer.
  HDlLayer CreateDlLayerAffineGrid(const HString& LayerName, Hlong Width, Hlong Height, const HString& GenParamName, const HString& GenParamValue) const;

  // Create an affine grid layer.
  HDlLayer CreateDlLayerAffineGrid(const char* LayerName, Hlong Width, Hlong Height, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create an affine grid layer.
  HDlLayer CreateDlLayerAffineGrid(const wchar_t* LayerName, Hlong Width, Hlong Height, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Create a layer for generating anchor boxes.
  HDlLayer CreateDlLayerAnchors(const HDlLayer& DLLayerInputImage, const HString& LayerName, const HTuple& AspectRatios, Hlong NumSubscales, const HTuple& Angles, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Create a layer for generating anchor boxes.
  HDlLayer CreateDlLayerAnchors(const HDlLayer& DLLayerInputImage, const HString& LayerName, const HTuple& AspectRatios, Hlong NumSubscales, const HTuple& Angles, const HString& GenParamName, const HString& GenParamValue) const;

  // Create a layer for generating anchor boxes.
  HDlLayer CreateDlLayerAnchors(const HDlLayer& DLLayerInputImage, const char* LayerName, const HTuple& AspectRatios, Hlong NumSubscales, const HTuple& Angles, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create a layer for generating anchor boxes.
  HDlLayer CreateDlLayerAnchors(const HDlLayer& DLLayerInputImage, const wchar_t* LayerName, const HTuple& AspectRatios, Hlong NumSubscales, const HTuple& Angles, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Create a layer for generating box proposals.
  static HDlLayer CreateDlLayerBoxProposals(const HDlLayerArray& DLLayerClassScore, const HDlLayerArray& DLLayerBoxDelta, const HDlLayerArray& DLLayerBox, const HDlLayer& DLLayerInputImage, const HString& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue);

  // Create a layer for generating box proposals.
  HDlLayer CreateDlLayerBoxProposals(const HDlLayer& DLLayerBoxDelta, const HDlLayer& DLLayerBox, const HDlLayer& DLLayerInputImage, const HString& LayerName, const HString& GenParamName, const HString& GenParamValue) const;

  // Create a layer for generating box proposals.
  HDlLayer CreateDlLayerBoxProposals(const HDlLayer& DLLayerBoxDelta, const HDlLayer& DLLayerBox, const HDlLayer& DLLayerInputImage, const char* LayerName, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create a layer for generating box proposals.
  HDlLayer CreateDlLayerBoxProposals(const HDlLayer& DLLayerBoxDelta, const HDlLayer& DLLayerBox, const HDlLayer& DLLayerInputImage, const wchar_t* LayerName, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Create a layer for generating box targets.
  static HDlLayerArray CreateDlLayerBoxTargets(const HDlLayerArray& DLLayerBoxProposal, const HDlLayer& DLLayerGTBox, const HDlLayer& DLLayerGTMask, const HTuple& LayerNames, const HString& InputMode, const HTuple& OutputModes, Hlong NumClasses, const HTuple& GenParamName, const HTuple& GenParamValue, HDlLayerArray* DLLayerBoxTargetsClsWeight, HDlLayerArray* DLLayerBoxTargetsBoxTarget, HDlLayerArray* DLLayerBoxTargetsBoxWeight, HDlLayer* DLLayerBoxTargetsNumFgInstances, HDlLayer* DLLayerBoxTargetsAssignedIdxs, HDlLayer* DLLayerBoxTargetsMaskWeight);

  // Create a layer for generating box targets.
  HDlLayer CreateDlLayerBoxTargets(const HDlLayer& DLLayerGTBox, const HDlLayer& DLLayerGTMask, const HString& LayerNames, const HString& InputMode, const HTuple& OutputModes, Hlong NumClasses, const HString& GenParamName, const HString& GenParamValue, HDlLayer* DLLayerBoxTargetsClsWeight, HDlLayer* DLLayerBoxTargetsBoxTarget, HDlLayer* DLLayerBoxTargetsBoxWeight, HDlLayer* DLLayerBoxTargetsNumFgInstances, HDlLayer* DLLayerBoxTargetsAssignedIdxs, HDlLayer* DLLayerBoxTargetsMaskWeight) const;

  // Create a layer for generating box targets.
  HDlLayer CreateDlLayerBoxTargets(const HDlLayer& DLLayerGTBox, const HDlLayer& DLLayerGTMask, const char* LayerNames, const char* InputMode, const HTuple& OutputModes, Hlong NumClasses, const char* GenParamName, const char* GenParamValue, HDlLayer* DLLayerBoxTargetsClsWeight, HDlLayer* DLLayerBoxTargetsBoxTarget, HDlLayer* DLLayerBoxTargetsBoxWeight, HDlLayer* DLLayerBoxTargetsNumFgInstances, HDlLayer* DLLayerBoxTargetsAssignedIdxs, HDlLayer* DLLayerBoxTargetsMaskWeight) const;

#ifdef _WIN32
  // Create a layer for generating box targets.
  HDlLayer CreateDlLayerBoxTargets(const HDlLayer& DLLayerGTBox, const HDlLayer& DLLayerGTMask, const wchar_t* LayerNames, const wchar_t* InputMode, const HTuple& OutputModes, Hlong NumClasses, const wchar_t* GenParamName, const wchar_t* GenParamValue, HDlLayer* DLLayerBoxTargetsClsWeight, HDlLayer* DLLayerBoxTargetsBoxTarget, HDlLayer* DLLayerBoxTargetsBoxWeight, HDlLayer* DLLayerBoxTargetsNumFgInstances, HDlLayer* DLLayerBoxTargetsAssignedIdxs, HDlLayer* DLLayerBoxTargetsMaskWeight) const;
#endif

  // Create a grid sample layer.
  HDlLayer CreateDlLayerGridSample(const HDlLayer& DLLayerGrid, const HString& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Create a grid sample layer.
  HDlLayer CreateDlLayerGridSample(const HDlLayer& DLLayerGrid, const HString& LayerName, const HString& GenParamName, const HString& GenParamValue) const;

  // Create a grid sample layer.
  HDlLayer CreateDlLayerGridSample(const HDlLayer& DLLayerGrid, const char* LayerName, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create a grid sample layer.
  HDlLayer CreateDlLayerGridSample(const HDlLayer& DLLayerGrid, const wchar_t* LayerName, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Create an ROI pooling layer.
  HDlLayer CreateDlLayerRoiPooling(const HDlLayer& DLLayerRoI, const HDlLayerArray& DLLayerFeature, const HDlLayer& DLLayerInstanceIndex, const HString& LayerName, const HString& Type, const HTuple& GridSize, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Create an ROI pooling layer.
  HDlLayer CreateDlLayerRoiPooling(const HDlLayer& DLLayerRoI, const HDlLayer& DLLayerFeature, const HDlLayer& DLLayerInstanceIndex, const HString& LayerName, const HString& Type, const HTuple& GridSize, const HString& GenParamName, const HString& GenParamValue) const;

  // Create an ROI pooling layer.
  HDlLayer CreateDlLayerRoiPooling(const HDlLayer& DLLayerRoI, const HDlLayer& DLLayerFeature, const HDlLayer& DLLayerInstanceIndex, const char* LayerName, const char* Type, const HTuple& GridSize, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create an ROI pooling layer.
  HDlLayer CreateDlLayerRoiPooling(const HDlLayer& DLLayerRoI, const HDlLayer& DLLayerFeature, const HDlLayer& DLLayerInstanceIndex, const wchar_t* LayerName, const wchar_t* Type, const HTuple& GridSize, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif

  // Create a slice layer.
  HDlLayer CreateDlLayerSlice(const HString& LayerName, const HTuple& Axes, const HTuple& StartIndices, const HTuple& EndIndices, const HTuple& Steps, const HTuple& GenParamName, const HTuple& GenParamValue) const;

  // Create a slice layer.
  HDlLayer CreateDlLayerSlice(const HString& LayerName, Hlong Axes, Hlong StartIndices, Hlong EndIndices, Hlong Steps, const HString& GenParamName, const HString& GenParamValue) const;

  // Create a slice layer.
  HDlLayer CreateDlLayerSlice(const char* LayerName, Hlong Axes, Hlong StartIndices, Hlong EndIndices, Hlong Steps, const char* GenParamName, const char* GenParamValue) const;

#ifdef _WIN32
  // Create a slice layer.
  HDlLayer CreateDlLayerSlice(const wchar_t* LayerName, Hlong Axes, Hlong StartIndices, Hlong EndIndices, Hlong Steps, const wchar_t* GenParamName, const wchar_t* GenParamValue) const;
#endif
