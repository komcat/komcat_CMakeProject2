...
// Segment an image using region growing for multi-channel images.
...
// Perform a region growing using mean gray values.
...
LIntExport void ApplyDeepMatching3d(const HObject& Images, const HTuple& Deep3DMatchingModel, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DeepMatchingResults);
...
LIntExport void ConnectImageSource(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Control actions available for an image source.
LIntExport void ControlImageSource(const HTuple& ImageSourceHandle, const HTuple& Action, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Result);

// Create a Deep 3D Matching model.
LIntExport void CreateDeepMatching3d(const HTuple& ObjectModel3D, const HTuple& Symmetry, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Deep3DMatchingModel);

// Create an affine grid layer.
LIntExport void CreateDlLayerAffineGrid(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Width, const HTuple& Height, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerAffineGrid);

// Create a layer for generating anchor boxes.
LIntExport void CreateDlLayerAnchors(const HTuple& DLLayerInput, const HTuple& DLLayerInputImage, const HTuple& LayerName, const HTuple& AspectRatios, const HTuple& NumSubscales, const HTuple& Angles, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerAnchors);

// Create a layer for generating box proposals.
LIntExport void CreateDlLayerBoxProposals(const HTuple& DLLayerClassScore, const HTuple& DLLayerBoxDelta, const HTuple& DLLayerBox, const HTuple& DLLayerInputImage, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBoxProposals);

// Create a layer for generating box targets.
LIntExport void CreateDlLayerBoxTargets(const HTuple& DLLayerBoxProposal, const HTuple& DLLayerGTBox, const HTuple& DLLayerGTMask, const HTuple& LayerNames, const HTuple& InputMode, const HTuple& OutputModes, const HTuple& NumClasses, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerBoxTargetsClsTarget, HTuple* DLLayerBoxTargetsClsWeight, HTuple* DLLayerBoxTargetsBoxTarget, HTuple* DLLayerBoxTargetsBoxWeight, HTuple* DLLayerBoxTargetsNumFgInstances, HTuple* DLLayerBoxTargetsAssignedIdxs, HTuple* DLLayerBoxTargetsMaskWeight);

// Create a grid sample layer.
LIntExport void CreateDlLayerGridSample(const HTuple& DLLayerInput, const HTuple& DLLayerGrid, const HTuple& LayerName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerGridSample);

// Create an ROI pooling layer.
LIntExport void CreateDlLayerRoiPooling(const HTuple& DLLayerInputImage, const HTuple& DLLayerRoI, const HTuple& DLLayerFeature, const HTuple& DLLayerInstanceIndex, const HTuple& LayerName, const HTuple& Type, const HTuple& GridSize, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerRoIPooling);

// Create a slice layer.
LIntExport void CreateDlLayerSlice(const HTuple& DLLayerInput, const HTuple& LayerName, const HTuple& Axes, const HTuple& StartIndices, const HTuple& EndIndices, const HTuple& Steps, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* DLLayerSlice);

// Create an image source handle.
LIntExport void CreateImageSource(const HTuple& PluginName, const HTuple& DeviceID, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ImageSourceHandle);

// Disconnect an image source.
LIntExport void DisconnectImageSource(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Fetch images and corresponding meta data from the image source buffer queue.
LIntExport void FetchFromImageSource(HObject* Images, const HTuple& ImageSourceHandle, HTuple* Data);

// Generate an image map based on non-regular correspondence points.
LIntExport void GenImageWarpMap(HObject* Map, const HTuple& Row1, const HTuple& Column1, const HTuple& Row2, const HTuple& Column2, const HTuple& ImageWidth, const HTuple& ImageHeight, const HTuple& MapWidth, const HTuple& MapHeight, const HTuple& Method, const HTuple& MapType, const HTuple& GenParamName, const HTuple& GenParamValue);

// Return the value of an image source parameter.
LIntExport void GetImageSourceParam(const HTuple& ImageSourceHandle, const HTuple& Param, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* Value);

// Read a parameter from a running Scene Engine instance.
LIntExport void GetSceneEngineParam(const HTuple& SceneEngine, const HTuple& GenParamName, HTuple* GenParamValue);

// Start and connect to the scene engine synthetic data generator.
LIntExport void OpenSceneEngine(const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* SceneEngine);

// Returns handles corresponding to image sources.
LIntExport void QueryImageSources(const HTuple& PluginName, const HTuple& GenParamName, const HTuple& GenParamValue, HTuple* ImageSourceHandles);

// Generate synthetic data using a running Scene Engine instance.
LIntExport void RunSceneEngine(const HTuple& SceneEngine, const HTuple& GenerationParams, HTuple* GeneratedData);

// Set a parameter of an image source.
LIntExport void SetImageSourceParam(const HTuple& ImageSourceHandle, const HTuple& Param, const HTuple& GenParamName, const HTuple& GenParamValue, const HTuple& Value);

// Sets a parameter of a running Scene Engine instance.
LIntExport void SetSceneEngineParam(const HTuple& SceneEngine, const HTuple& GenParamName, const HTuple& GenParamValue);

// Acquire an image with corresponding meta data from an image source.
LIntExport void SnapFromImageSource(HObject* Images, const HTuple& ImageSourceHandle, HTuple* Data);

// Prepare the image source for continuously acquiring, transmitting and receiving images.
LIntExport void StartImageSource(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);

// Stop the continuous acquisition, transmission and reception of images of the image source.
LIntExport void StopImageSource(const HTuple& ImageSourceHandle, const HTuple& GenParamName, const HTuple& GenParamValue);
