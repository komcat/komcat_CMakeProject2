...
#define TLPM_PID_PM6x_DFU            (0x80B4)   // PM6x on USB with DFU interface enabled (Interface 0 TMC, Interface 1 DFU)
/**@}*/  /* TLPM_PID_x */
...
#define PMNET_FIND_PATTERN          "TCPIP?*:INSTR{VI_ATTR_TCPIP_DEVICE_NAME==\"PM5020\" || VI_ATTR_TCPIP_DEVICE_NAME==\"PM103E\"}"
#define PMBTH_FIND_PATTERN			"BTHLE?*"
...
//#define VI_INSTR_ERROR_INV_CHANNEL     (VI_INSTR_ERROR_OFFSET + 0x02L)   /* BFFC0902, -1074001662 */ 
...
/*========================================================================*//**
\defgroup   TLPM_TRIGGER_SRC_x  Attributes
\details 	Input source of the trigger
\ingroup    TLPM_MACROS_x
@{
*//*=========================================================================*/
#define TLPM_TRIGGER_SRC_CHANNEL_1 	(1)
#define TLPM_TRIGGER_SRC_CHANNEL_2 	(2)
#define TLPM_TRIGGER_SRC_FRONT_AUX 	(3)
#define TLPM_TRIGGER_SRC_REAR 		(4)
/**@}*/  /* TLPM_TRIGGER_SRC_x */  
...
ViStatus _VI_FUNC TLPMX_initWithEncryption (ViRsrc rsc, ViBoolean IDQuery, ViBoolean reset, ViChar password[], ViPSession pInstr);
...
*//*=========================================================================*/
	...
	*//*=========================================================================*/
		...
		*//*=========================================================================*/
		...
		ViStatus _VI_FUNC TLPMX_startZeroPos (ViSession vi, ViUInt16 channel);
		ViStatus _VI_FUNC TLPMX_cancelZeroPos (ViSession vi, ViUInt16 channel);
		ViStatus _VI_FUNC TLPMX_setZeroPos (ViSession vi, ViReal64 zeroX, ViReal64 zeroY, ViUInt16 channel);
		ViStatus _VI_FUNC TLPMX_getZeroPos (ViSession vi, ViPReal64 pZeroX, ViPReal64 pZeroY, ViUInt16 channel);
	...
	*//*=========================================================================*/ 
	...
	/*========================================================================*//**
	\defgroup   TLPM_MEAS_UNIT_x  Available measurement units
	\ingroup    TLPM_MACROS_x
	@{
	*//*=========================================================================*/
	#define TLPM_MEAS_POWER    (0)
	#define TLPM_MEAS_CURRENT  (1)
	#define TLPM_MEAS_VOLTAGE  (2)
	#define TLPM_MEAS_PDENSITY (3)
	#define TLPM_MEAS_ENERGY   (4)
	#define TLPM_MEAS_EDENSITY (5)
	/**@}*/  /* TLPM_MEAS_UNIT_x */ 
	ViStatus _VI_FUNC TLPMX_measDualChannelSimultaneous (ViSession vi, ViUInt16 measurement, ViPReal64 resultChannel1, ViPReal64 resultChannel2);
	...
	ViStatus _VI_FUNC TLPMX_measureVoltageMeasurementSequence 			(ViSession vi, ViUInt32 baseTime, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_measureVoltageMeasurementSequenceHWTrigger 	(ViSession vi, ViUInt32 baseTime, ViUInt32 hPos, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_getFetchState (ViSession vi, ViPBoolean state, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_blockFetch (ViSession vi, ViUInt32 timeout, ViPReal64 result, ViUInt16 channel);
	...
	*//*=========================================================================*/ 
	...
	ViStatus _VI_FUNC TLPMX_confFastArrayMeasurement 			(ViSession vi, ViUInt16 measurement, ViUInt16 channel);
	...
	ViStatus _VI_FUNC TLPMX_getNextFastArrayMeasurement 		(ViSession vi, ViPUInt32 count, ViUInt32 timestamps[], ViReal32 values[], ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_getNextFastArrayMeasurementRelativeTime (ViSession vi, ViPUInt32 count, ViUInt32 timestamps[], ViReal32 values[], ViUInt16 channel);
	...
	ViStatus _VI_FUNC TLPMX_confVolatgeMeasurementSequence 			(ViSession vi, ViUInt32 baseTime, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_confVolatgeMeasurementSequenceHWTrigger (ViSession vi, ViUInt16 trigSrc, ViUInt32 baseTime, ViUInt32 hPos, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_confPDENMeasurementSequence 			(ViSession vi, ViUInt32 baseTime, ViUInt16 channel);

	ViStatus _VI_FUNC TLPMX_startMeasurementSequence(ViSession vi, ViUInt32 autoTriggerDelay, ViPBoolean triggerForced);
	ViStatus _VI_FUNC TLPMX_getMeasurementSequence(ViSession vi, ViUInt32 baseTime, ViReal32 timeStamps[], ViReal32 values[], ViReal32 values2[]);
	
	ViStatus _VI_FUNC TLPMX_confBurstArrayMeasPowerChannel (ViSession vi, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_confBurstArrayMeasCurrentChannel (ViSession vi, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_confBurstArrayMeasVoltageChannel (ViSession vi, ViUInt16 channel);
	ViStatus _VI_FUNC TLPMX_confBurstArrayMeasTrigger (ViSession vi, ViUInt32 trgSource, ViUInt32 initDelay, ViUInt32 burstCount, ViUInt32 averaging);
	...
	ViStatus _VI_FUNC TLPMX_getBurstArraySamples (ViSession vi, ViUInt32 startIndex, ViUInt32 sampleCount, ViUInt32 timeStamps[], ViReal32 values[], ViReal32 values2[]);
	ViStatus _VI_FUNC TLPMX_disableArrayMeasurementChannel (ViSession vi, ViUInt16 channel);
...
/*========================================================================*//**
\defgroup   TLPM_I2C_MODE_x  I2C Operation Mode
\ingroup    TLPM_MACROS_x
@{
*//*=========================================================================*/
#define I2C_OPER_INTER 	     (0)
#define I2C_OPER_SLOW 	     (1)
#define I2C_OPER_FAST        (2)
/**@}*/  /* TLPM_I2C_MODE_x */ 
ViStatus _VI_FUNC TLPMX_setI2CMode (ViSession instrumentHandle, ViUInt16 mode); 
ViStatus _VI_FUNC TLPMX_getI2CMode (ViSession instrumentHandle, ViPInt16 mode); 
ViStatus _VI_FUNC TLPMX_I2CRead (ViSession instrumentHandle, ViUInt32 address, ViUInt32 count, ViPUInt32 dataRead);
ViStatus _VI_FUNC TLPMX_I2CWrite (ViSession instrumentHandle, ViUInt32 address, ViString hexData); 
ViStatus _VI_FUNC TLPMX_I2CWriteRead (ViSession instrumentHandle, ViUInt32 address, ViString hexSendData, ViUInt32 count, ViPUInt32 dataRead);
...
/*========================================================================*//**
\defgroup   TLPM_FAN_TEMPERATUR_CONTROL_MODE_x  Fan Temperature Control Mode
\ingroup    TLPM_MACROS_x
@{
*//*=========================================================================*/
#define FAN_TEMPER_SRC_HEAD 	     (0)
#define FAN_TEMPER_SRC_EXT_NTC 	     (1)
/**@}*/  /* TLPM_FAN_TEMPERATUR_CONTROL_MODE_x  */ 
...
/*========================================================================*//**
\defgroup   TLPM_LASER_CONTROL_MODE_x  laser Control Mode
\ingroup    TLPM_METHODS_x
@{
*//*=========================================================================*/
ViStatus _VI_FUNC TLPMX_setLaserState (ViSession vi, ViBoolean state, ViUInt32 frequency, ViUInt32 duration);
ViStatus _VI_FUNC TLPMX_getLaserState (ViSession vi, ViPBoolean state);
/**@}*/  /* TLPM_LASER_CONTROL_MODE_x */ 
...
ViStatus _VI_FUNC TLPMX_importSettingsFromJson (ViSession vi, ViBoolean adapt, ViChar _VI_FAR settings[]);
ViStatus _VI_FUNC TLPMX_exportSettingsAsJson (ViSession vi, ViChar _VI_FAR settings[], ViUInt32 settingsSize);
...
#define TLPM_SENS_FLAG_IS_UNDEFINED  0x0000 // Undefined sensor
...
ViStatus _VI_FUNC TLPMX_setEncryption (ViSession vi, ViString oldPassword, ViString newPassword, ViBoolean encryption);
ViStatus _VI_FUNC TLPMX_getEncryption(ViSession vi, ViChar password[], ViPBoolean encryption);
ViStatus _VI_FUNC TLPMX_setLANPropagation(ViSession vi, ViBoolean enable);
ViStatus _VI_FUNC TLPMX_getLANPropagation (ViSession vi, ViPBoolean enable);
ViStatus _VI_FUNC TLPMX_setEnableNetSearch (ViSession vi, ViBoolean enable);
ViStatus _VI_FUNC TLPMX_getEnableNetSearch(ViSession vi, ViPBoolean enable);
ViStatus _VI_FUNC TLPMX_setLookForInfoOnSearch(ViSession instr, ViBoolean enable);
ViStatus _VI_FUNC TLPMX_getLookForInfoOnSearch(ViSession instr, ViPBoolean enable);
ViStatus _VI_FUNC TLPMX_setNetSearchMask(ViSession vi, ViString netMask);
/**@}*/  /* TLPM_METHODS_ETHERNET_INTERFACE_x */   

/*========================================================================*//**
\defgroup   TLPM_METHODS_BLUETOOTH_INTERFACE_x Attributes Functions
\ingroup    TLPM_METHODS_x
@{
*//*=========================================================================*/ 
ViStatus _VI_FUNC TLPMX_setEnableBthSearch (ViSession vi,ViBoolean enable);
ViStatus _VI_FUNC TLPMX_getEnableBthSearch (ViSession vi,ViPBoolean enable);
/**@}*/  /* TLPM_METHODS_BLUETOOTH_INTERFACE_x */   
...
/*========================================================================*//**
\defgroup   TLPM_FILE_TRANSFER_x Attributes Functions
\ingroup    TLPM_METHODS_x
\brief      This class of functions provides functions to transfer file content from the device
@{
*//*=========================================================================*/ 
ViStatus _VI_FUNC TLPMX_listDirectory (ViSession vi, ViString path, ViUInt32 offset);
ViStatus _VI_FUNC TLPMX_fileOpen (ViSession vi, ViString path);
ViStatus _VI_FUNC TLPMX_fileRead (ViSession vi, ViUInt32 offset, ViUInt32 length, ViBoolean asHex);
ViStatus _VI_FUNC TLPMX_fileClose (ViSession vi);
ViStatus _VI_FUNC TLPMX_deviceParamsImport (ViSession vi, ViBoolean adapt, ViString JSONData);
ViStatus _VI_FUNC TLPMX_deviceParamsExport (ViSession vi, ViChar JSONData[]);
/**@}*/  /* TLPM_FILE_TRANSFER_x */  
