...
#define PMNET_FIND_PATTERN            "TCPIP?*:INSTR{VI_ATTR_TCPIP_DEVICE_NAME==\"PM103E\"}"
...
*//*=========================================================================*/
	...
	*//*=========================================================================*/
		...
		*//*=========================================================================*/
		...
		ViStatus _VI_FUNC TLPM_startZeroPos (ViSession vi);
		ViStatus _VI_FUNC TLPM_cancelZeroPos (ViSession vi);
		ViStatus _VI_FUNC TLPM_setZeroPos (ViSession vi, ViReal64 zeroX, ViReal64 zeroY);
		ViStatus _VI_FUNC TLPM_getZeroPos (ViSession vi, ViPReal64 pZeroX, ViPReal64 pZeroY);
	...
	*//*=========================================================================*/ 
	...
	ViStatus _VI_FUNC TLPM_measHeadTemperature (ViSession instr, ViPReal64 pVal);
...
@{
*//*=========================================================================*/ 
ViStatus _VI_FUNC TLPM_setIPAddress (ViSession vi, ViChar IPAddress[]);
ViStatus _VI_FUNC TLPM_getIPAddress (ViSession vi, ViChar IPAddress[]);
ViStatus _VI_FUNC TLPM_setIPMask (ViSession vi, ViChar IPMask[]);
ViStatus _VI_FUNC TLPM_getIPMask (ViSession vi, ViChar IPMask[]);
ViStatus _VI_FUNC TLPM_getMACAddress (ViSession vi, ViChar MACAddress[]);
ViStatus _VI_FUNC TLPM_setDHCP (ViSession vi, ViChar DHCP[]);
ViStatus _VI_FUNC TLPM_getDHCP (ViSession vi, ViChar DHCP[]);
ViStatus _VI_FUNC TLPM_setHostname (ViSession vi, ViChar hostname[]);
ViStatus _VI_FUNC TLPM_getHostname (ViSession vi, ViChar hostname[]);
ViStatus _VI_FUNC TLPM_setWebPort (ViSession vi, ViUInt32 port);
ViStatus _VI_FUNC TLPM_getWebPort (ViSession vi, ViPUInt32 port);
ViStatus _VI_FUNC TLPM_setSCPIPort (ViSession vi, ViUInt32 port);
ViStatus _VI_FUNC TLPM_getSCPIPort (ViSession vi, ViPUInt32 port);
ViStatus _VI_FUNC TLPM_setDFUPort (ViSession vi, ViUInt32 port);
ViStatus _VI_FUNC TLPM_getDFUPort (ViSession vi, ViPUInt32 port);
ViStatus _VI_FUNC TLPM_setEncryption (ViSession vi, ViString oldPassword, ViString newPassword, ViBoolean encryption);
ViStatus _VI_FUNC TLPM_getEncryption(ViSession vi, ViChar password[], ViPBoolean encryption);
ViStatus _VI_FUNC TLPM_setLANPropagation(ViSession vi, ViBoolean enable);
ViStatus _VI_FUNC TLPM_getLANPropagation (ViSession vi, ViPBoolean enable);
ViStatus _VI_FUNC TLPM_setEnableNetSearch (ViSession vi, ViBoolean enable);
ViStatus _VI_FUNC TLPM_getEnableNetSearch(ViSession vi, ViPBoolean enable);
ViStatus _VI_FUNC TLPM_setLookForInfoOnSearch(ViSession instr, ViBoolean enable);
ViStatus _VI_FUNC TLPM_getLookForInfoOnSearch(ViSession instr, ViPBoolean enable);
ViStatus _VI_FUNC TLPM_setNetSearchMask(ViSession vi, ViString netMask);
