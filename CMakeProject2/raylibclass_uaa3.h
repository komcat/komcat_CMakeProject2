...
public:
  ...
  // Camera management for video feed
  void SetCameraManager(CameraManager* cameraManager);
  void SetActiveCamera(const std::string& cameraId);
  std::string GetActiveCamera() const;
...
private:
  ...
  CameraManager* m_cameraManager = nullptr;  // Add this member
  std::string m_activeCameraId;              // Add this member
